...
//       });//rq end
      ...
      $(".rq").change(function() { //request 드롭다운 값 변경시
    	  	console.log($(this).attr("id")); //누른 것의 아이디
    	  	var id = $(this).attr("id");
			console.log($("#"+id+ " option:selected").data("value").note); //해당 아이디의 data-value 값 추출
	});//rq change end
   });   
</script>
</head>
            ...
            <tbody>
               <tr>
                   <td><select id="finance_id0" class="rq">
                      <option value="12">재무고유번호</option>
                               <option value="test" data-value='{"num":"1","amount_krw":"amount_krw","note":"note"}'>1</option>
                      </select></td>
